...
*xview*: [enso_surface_step3.xview](./xviews/enso_surface_step3.xview).
...
contour values. Then click the *>>* Button. Choose *-10* Start, *1* Increment, *10* End.
Click on Apply. Open the *Set Ranges* (*ALT+R*) and set the Temperature range from -10 to
10.

![alt text](./img/enso_surface_step_6.png "Current") 
*xview*: [enso_surface_step6.xview](./xviews/enso_surface_step6.xview).
